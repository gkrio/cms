...
class ThemesServiceProvider extends ServiceProvider
{
    ...
    {
        $this->commands('Gkrio\Themes\Console\MakeCommand');
        $this->commands('Gkrio\Themes\Console\CacheCommand');
        $this->commands('Gkrio\Themes\Console\ListCommand');
        $this->commands('Gkrio\Themes\Console\PublishCommand');
    }
